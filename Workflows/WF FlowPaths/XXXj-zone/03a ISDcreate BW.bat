...
SET SRCPATH=tmp
SET SRCFILTER=%SOURCE_IPFFILE:.IPF=%_RECT%FPBW_ISD_RECTSIZE%.GEN
SET N1=%FPBW_ISD_N1%
SET N2=%FPBW_ISD_N2%
SET TOP=%FPBW_ISD_TOP%
SET BOT=%FPBW_ISD_BOT%
SET VIN=%FPBW_ISD_VIN%
SET RESULTPATH=%RESULTPATH_SP%
SET ISDFILE=BW_%SOURCEABBR%_9c%N1:.0=%m%VIN%x.ISD
