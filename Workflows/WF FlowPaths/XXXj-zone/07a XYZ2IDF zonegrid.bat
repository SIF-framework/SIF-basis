...
SET SOURCEPATH=tmp
SET SOURCEFILE=%MODELREF%_FW_CHULLBUFFER_EPsel.IPF
SET IXCOL=
SET IYCOL=
SET IZCOL=13
SET WINDOW=
SET GRIDFUNC=MIN
SET CELLSIZE=%FPFW_ISDP_N1%
SET IDFNODATA=-9999
SET RESULTPATH=%RESULTPATH_ZONE%
SET RESULTFILE=%TYPESTRING%_FW_%MODELREF%_%SOURCEABBR%.IDF
SET METADATA_DESCRIPTION=Gridded IPF-points of %TYPESTRING% via iMOD-batchfunction XYZTOIDF and GRIDFUNC=%GRIDFUNC%
