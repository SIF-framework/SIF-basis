...
SET XMLFILE=%FLOWLINE_PREFIX%%TYPESTRING%_FW_%MODELREF%_%SOURCEABBR%.shp.XML
...
SET M004=v1.0
SET M005=Stroombanen %TYPESTRING% winning %SOURCEABBR%
SET M006=Herberekening grondwaterbeschermingsgebied voor winning %SOURCEABBR%
SET M007=Stroombanen van %TYPESTRING% met reistijd in jaren tot aan winning %SOURCEABBR% o.b.v. voorwaartse berekening vanuit bufferzone rondom terugwaarts berekende %TYPESTRING%. Startpunten tussen %ISFFW_TOPSTRING% en %ISFFW_BOTSTRING%, iedere %FPFW_ISDL_N1%x%FPFW_ISDL_N2%m en %FPFW_ISDL_VIN% punten per verticaal. Model voor stroombaanberekening is %MODELREF%.
SET M008=%CONTACTORG%
