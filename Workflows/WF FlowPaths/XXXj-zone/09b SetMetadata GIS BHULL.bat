...
SET XMLFILE=%TYPESTRING%_FW_%MODELREF%_%SOURCEABBR%_BHULL.shp.XML
...
SET M004=v1.0
SET M005=Contour %TYPESTRING% winning %SOURCEABBR%
SET M006=Herberekening grondwaterbeschermingsgebied voor winning %SOURCEABBR%
SET M007=Contour van %TYPESTRING% voor winning %SOURCEABBR% o.b.v. voorwaartse berekening vanuit bufferzone rondom terugwaarts berekende %TYPESTRING%. De contour is bepaald als een bounding hull op de celranden van het zonegrid. Model voor stroombaanberekening is %MODELREF%.
SET M008=%CONTACTORG%
