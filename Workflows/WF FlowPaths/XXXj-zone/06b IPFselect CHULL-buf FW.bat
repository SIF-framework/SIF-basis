...
SET IPFPATH=%RESULTPATH_RUNS%\FW_CHULLBUFFER
SET IPFFILTER=%MODELREF%_FW_CHULLBUFFER_EP.IPF
SET XCOLIDX=7
SET YCOLIDX=8
SET ZCOLIDX=9
...
SET RESULTPATH=tmp\%MODELREF%_FW_CHULLBUFFER_EPsel.IPF
