...
SET IPFPATH=%RESULTPATH_RUNS%\BW_%SOURCEABBR%_9c%FPBW_ISD_N1:.0=%m%FPBW_ISD_VIN%x
SET IPFFILTER=%MODELREF%_BW_%SOURCEABBR%_9c%FPBW_ISD_N1:.0=%m%FPBW_ISD_VIN%x_EP.IPF
SET XCOLNR=7
SET YCOLNR=8
SET CONVERTMETHOD=2
SET RECTANGLESIZE=
